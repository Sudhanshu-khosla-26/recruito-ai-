...
const MOCK_JOBS = [
    { id: 1, title: 'HR Manager', location: 'Mumbai, India', description: 'Manages human resources policies and programs. This includes recruiting, compensation, benefits, and employee relations.' },
    { id: 2, title: 'Software Engineer', location: 'Bengaluru, India', description: 'Designs, develops, and maintains software applications. Requires strong problem-solving skills and experience with modern frameworks.' },
    { id: 3, title: 'Product Manager', location: 'New Delhi, India', description: 'Defines the product vision and strategy. Collaborates with engineering, design, and marketing teams to deliver on product goals.' },
    { id: 4, title: 'Data Analyst', location: 'Pune, India', description: 'Collects, processes, and performs statistical analyses of data. Interprets data to help businesses make better decisions.' },
    { id: 5, title: 'UX Designer', location: 'Hyderabad, India', description: 'Focuses on creating intuitive and enjoyable user experiences. Conducts user research, creates wireframes, and prototypes.' },
    { id: 6, title: 'DevOps Engineer', location: 'Mumbai, India', description: 'Combines software development and IT operations to shorten the systems development life cycle and provide continuous delivery with high software quality.' },
    { id: 7, title: 'HR Manager', location: 'Mumbai, benefits, and employee relations.' },
    { id: 8, title: 'HR Manager', location: 'Mumbai, India', description: 'Manages human resources policies and programs. This includes recruiting, compensation, benefits, and employee relations.' },
    { id: 9, title: 'HR Manager', location: 'Mumbai, India', description: 'Manages human resources policies and programs. This includes recruiting, compensation, benefits, and employee relations.' },
    { id: 10, title: 'HR Manager', location: 'Mumbai, India', description: 'Manages human resources policies and programs. This includes recruiting, compensation, benefits, and employee relations.' },
];

const mockCtcOptions = [
    { label: '0-5 Lacs', value: '0-5' },
    { label: '5-10 Lacs', value: '5-10' },
    { label: '10-15 Lacs', value: '10-15' },
    { label: '15-20 Lacs', value: '15-20' },
];
...
function App() {
    ...
    const displayedJobs = MOCK_JOBS.slice(
        (currentPage - 1) * jobsPerPage,
        currentPage * jobsPerPage
    );

    const handleSearch = () => {
        console.log('Searching with:', { jobTitle, experience, location, ctcRange });
    };
                    ...
                    <div className="col-span-1 bg-gray-50 dark:bg-gray-950 rounded-xl shadow-md p-5 flex flex-col gap-4">
                        {selectedJobs.length === 1 ? (
                                ...
                                {isEditing ? (
                                    <>
                                        <div className="border-b pb-4 flex-1">
                                            <p className="text-xs font-semibold text-gray-700 dark:text-gray-300">
                                                ...
                                                <Input
                                                    ...
                                                    className="font-normal text-gray-500 bg-transparent border-none focus:ring-0 focus:border-0"
                                                />
                                            </p>
                                            <p className="text-xs font-semibold text-gray-700 dark:text-gray-300">
                                                Location:
                                        ...
                                        <div className="flex-1 overflow-y-auto">
                                            <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Job Description Details</h3>
                                            <textarea
                                                value={editedDescription}
                                                onChange={(e) => setEditedDescription(e.target.value)}
                                                className="w-full h-full text-xs text-gray-600 dark:text-gray-400 bg-transparent border rounded-xl p-2 focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 transition-colors duration-200"
                                            />
                                        </div>
                                    ...
                                    <>
                                        <div className="border-b pb-4">
                                            <p className="text-xs font-semibold text-gray-700 dark:text-gray-300">Job Title: <span className="font-normal text-gray-500">{firstSelectedJob.title}</span></p>
                                            <p className="text-xs font-semibold text-gray-700 dark:text-gray-300">Location: <span className="font-normal text-gray-500">{firstSelectedJob.location}</span></p>
                                        </div>
                                        <div className="flex-1 overflow-y-auto">
                                            <h3 className="font-semibold text-gray-800 dark:text-gray-100 mb-2">Job Description Details</h3>
                                            <p className="text-xs text-gray-600 dark:text-gray-400">{firstSelectedJob.description}</p>
                                        </div>
                                        <Button
                                            variant="solid"
                                            size="sm"
                            ...
                            <div className="flex items-center justify-center h-full">
                                <p className="text-xs text-gray-500 dark:text-gray-400 text-center">Select a single job description to view and edit its details.</p>
                            </div>
                        ) : (
                            <div className="flex items-center justify-center h-full">
                                <p className="text-xs text-gray-500 dark:text-gray-400 text-center">Based on the selection of the Job description, the details will populate.</p>
                            </div>
                        )}
                    </div>
                </div>
