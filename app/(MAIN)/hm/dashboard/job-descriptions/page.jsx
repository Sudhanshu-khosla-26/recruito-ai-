...
function App() {
    ...
    return (
        <div className="h-screen bg-gray-100 dark:bg-gray-900 font-sans p-2 text-xs flex flex-col">
            <div className="bg-white dark:bg-gray-950 rounded-xl shadow-md p-3 sm:p-5 flex-1 flex flex-col gap-4">

                {/* Search Header */}
                <div className="flex flex-col lg:flex-row items-center gap-3 sm:gap-4 mt-3 sm:mt-5">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 h-full overflow-hidden">
                    ...
                    <div className="col-span-1 flex flex-col gap-3 sm:gap-4 overflow-y-auto max-h-[calc(100vh-200px)] lg:max-h-full">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mt-3 sm:mt-5">
                            ...
                            <div className="flex flex-wrap items-center gap-2 sm:gap-3 w-full sm:w-auto">
                                ...
                                {selectedJobs.length > 0 && (
                                    <Button variant="outline" className="flex items-center gap-1 text-xs sm:text-sm whitespace-nowrap" onClick={() => setIsShareModalOpen(true)}>
                                ...
                                >
                                    <span className="text-green-500 font-semibold text-xs whitespace-nowrap">+ Create Job</span>
                                </Button> */}
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                            {displayedJobs.length === 0 ? (
                                <div className="col-span-full flex flex-col items-center justify-center py-12 sm:py-16">
                                    <svg className="h-16 w-16 sm:h-20 sm:w-20 text-gray-300 dark:text-gray-700 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                    <h3 className="text-sm sm:text-base font-semibold text-gray-700 dark:text-gray-300 mb-2">No Jobs Found</h3>
                                    <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 text-center px-4">
                                        Try adjusting your search filters or create a new job description
                                    </p>
                                </div>
                            ) : (
                                displayedJobs.map((job) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <h3 className="font-semibold text-gray-800 dark:text-gray-100 text-xs truncate">{job.title}</h3>
                    ...
                    <div className="col-span-1 bg-gray-50 dark:bg-gray-950 rounded-xl shadow-md p-3 sm:p-5 flex flex-col gap-3 sm:gap-4 max-h-[calc(100vh-200px)] lg:max-h-full overflow-y-auto">
