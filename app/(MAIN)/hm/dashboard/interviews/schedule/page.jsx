                    ...
                    <td className="py-2 w-48">
                      <div className="flex items-center gap-1">
                        <select
                          ...
                          disabled={["Skip", "Not Suitable", "Completed"].includes(c.status)}
                          className={`border rounded px-1 py-0.5 text-[10px] flex-shrink-0 shadow-sm ${["Skip", "Not Suitable", "Completed"].includes(c.status)
